...
パーセプトロンは人間の発明です。そしてパーセプトロンに期待通りの動作をしてもらうためには様々な工夫を施しています。その中、活性化関数もその一つです。活性化関数を用いることで、パーセプトロン（或は人工ニューロン）にある特定の（人間にとって都合の良い）振る舞いをしてもらえるようになります。どんな活性化関数するには、それは研究者の様々な研究の結果によって、それぞれの特性を見て選択するものです。
